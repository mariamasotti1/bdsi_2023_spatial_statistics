...
![[source](https://www.usairnet.com/weather/maps/current/current-temperature/)](temp.png)

## Point Pattern Data

The main interest is in the locations of all occurrences of some event. Exact locations are recorded.

![[source](https://www.nbcnews.com/sciencemain/looking-bigfoot-follow-map-others-have-seen-em-there-4b11203811)](bigfoot_sighting.webp)
...
![[source](https://www.satelliteinternet.com/resources/states-with-the-most-bigfoot-sightings/)](bigfoot_state.jpeg)


## Spatial data are everywhere

-   [The Climate Impact of Your Neighborhood (NYT)](https://www.nytimes.com/interactive/2022/12/13/climate/climate-footprint-map-neighborhood.html)

-   [MTA Ridership Changes due to COVID-19 (TWO-N Inc)](https://projects.two-n.com/mta/#section-map-2)

-   [Spain Lives in Flats (especiales.eldiario.es)](https://especiales.eldiario.es/spain-lives-in-flats/)
...
![[Source](https://mgimond.github.io/Spatial/spatial-autocorrelation.html)](images/Screen%20Shot%202023-07-17%20at%202.07.16%20PM.png)
...
1.  Identify best neighborhoods to purchase a house
2.  Determine what variables influence MHV in SE Michigan
3.  Check for non-stationarity in the effects of the influential variables
...
![[Source](https://gistbok.ucgis.org/bok-topics/geographically-weighted-regression-framework)](images/Screen%20Shot%202023-07-12%20at%2010.19.41%20AM.png)
...
![[Source](https://gistbok.ucgis.org/bok-topics/geographically-weighted-regression-framework)](gwr.png)
...
::: {.column width="60%"}
![[Source](https://gistbok.ucgis.org/bok-topics/geographically-weighted-regression-framework)](gwr2.png)
:::
:::
...
![Spatial weights at different bandwidths for areal data. [Source](https://gistbok.ucgis.org/bok-topics/geographically-weighted-regression-framework)](bw.png)
